...
const Earth = forwardRef(({ sunRef }, ref) => {
    ...
    const lightPath = new THREE.BufferGeometry().setFromPoints([ directLightPostition, directLightTarget ]);
    ...
    return (
        <group ref={earthOrbitRef}>
            ...
            <mesh position={directLightPostition} castShadow>
                ...
                <directionalLight castShadow color={0xFFFFFF} intensity={5} position={directLightTarget}/>
                <axesHelper args={[10]} />
            </mesh>
        </group>
    );
